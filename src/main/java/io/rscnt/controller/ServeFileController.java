...
public class ServeFileController {
	...
	@RequestMapping(value = "/banners/{banner_name}", method = RequestMethod.GET)
	@ResponseBody
	public HttpEntity<FileSystemResource> getBanner(
			@PathVariable("banner_name") String fileName) {
